...
import { $, $$, fitCanvas, clamp } from '../assets/vhs.js?v=202609252015';
import { t } from '../assets/i18n.js?v=202609252015';
import { bindSeg, isPressed, setPressed, togglePressed, tile } from '../assets/lab.js?v=202609252015';
import { renderCode } from '../assets/code.js?v=202609252015';
import { SHADERS, SNIPPETS } from './snippets.js?v=202609252015';
import {
  SHADER_STEPS, SHADER_CAPS, addedLines, fresnelHaloAlpha, lambert, silhouetteSummary, buildFrameGraph, nativePasses,
} from './model-frame.js?v=202609252015';
