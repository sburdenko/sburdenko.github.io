...
import { initMap, initSolid } from './lab-solid.js?v=202609162304';
import { initFactory, initPool, initSingleton } from './lab-creation.js?v=202609162304';
import { initCommand, initState, initObserver, initStrategy } from './lab-behavior.js?v=202609162304';
import { initUi, initFlyweight, initDirty, initLazy } from './lab-data.js?v=202609162304';
import { initChooser, initInterview } from './lab-choose.js?v=202609162304';
