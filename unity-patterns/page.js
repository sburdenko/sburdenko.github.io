...
import { initMap, initSolid } from './lab-solid.js?v=202609252015';
import { initFactory, initPool, initSingleton } from './lab-creation.js?v=202609252015';
import { initCommand, initState, initObserver, initStrategy } from './lab-behavior.js?v=202609252015';
import { initUi, initFlyweight, initDirty, initLazy } from './lab-data.js?v=202609252015';
import { initChooser, initInterview } from './lab-choose.js?v=202609252015';
